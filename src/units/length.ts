...
export function convertLengthToPx(length: string, { em = 16, ic = 16, ex = 7.2, width, height }: Config) {
    ...
    switch (unit) {
        ...
        case "lh":
        case "rlh":
            console.warn(unit + " isn’t supported yet");
            return null; // TODO: implement those later
        default:
            console.warn(unit + " isn’t supported");
            return null;
    }
}
